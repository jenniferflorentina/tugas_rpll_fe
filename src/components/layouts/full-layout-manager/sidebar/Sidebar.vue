<template>
  ...
  >
    <v-list-item class="ml-1 pa-2">
      <h3 class="font-weight-bold color">HB.</h3>
      <v-list-item-title class="ml-4 color">Harapan Bangsa</v-list-item-title>
      <v-btn @click.stop="mini = !mini" plain>
    ...
    <template v-slot:append>
      <v-list expand nav>
        <v-list-item class="color my-2" @click="onClickHandler()">
          <v-list-item-icon>
